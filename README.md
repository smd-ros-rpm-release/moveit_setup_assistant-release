...
## moveit_setup_assistant - 0.5.8-0

User `schitta@schitta-pc` released the packages in the `moveit_setup_assistant` repository by running `/usr/bin/bloom-release moveit_setup_assistant --track hydro --rosdistro hydro` on `Thu, 06 Feb 2014 23:52:54 -0000`
...
## moveit_setup_assistant - 0.5.5-0

User `hersh@frogs` released the packages in the `moveit_setup_assistant` repository by running `/usr/bin/bloom-release moveit_setup_assistant --track hydro --rosdistro hydro` on `Tue, 03 Dec 2013 22:51:54 -0000`
...
## moveit_setup_assistant - 0.5.4-0

User `isucan@e6400` released the packages in the `moveit_setup_assistant` repository by running `/usr/bin/bloom-release -t hydro -r hydro moveit_setup_assistant` on `Fri, 11 Oct 2013 13:10:10 -0000`
...
## moveit_setup_assistant - 0.5.3-0
